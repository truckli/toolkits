...
data = xlrd.open_workbook('201606.xls')
table = data.sheets()[0]
nrows = table.nrows
ncols = table.ncols
summary = {}
curno = None
scandates_m = [1,2, 6,7,8,12,13,14,15,16,17,20,21,22,23,24,27,28,29]
scandates = []
# 2015/12/31 => 42369
# 1899/12/30 => 0 

scandates.append((datetime(2016,5,30) - datetime(1899,12,30)).days)
scandates.append((datetime(2016,5,31) - datetime(1899,12,30)).days)
for d in scandates_m:
    scandates.append((datetime(2016,6,d) - datetime(1899,12,30)).days)
